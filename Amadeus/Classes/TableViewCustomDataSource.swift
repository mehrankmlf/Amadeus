...
extension TableViewCustomDataSource where Model == DataResponse {
    static func displayData(for itemLists:[DataResponse],withCellidentifier reuseIdentifier: String)-> TableViewCustomDataSource {
